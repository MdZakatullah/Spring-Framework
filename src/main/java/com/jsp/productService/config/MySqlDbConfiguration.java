package com.jsp.productService.config;
...
public class MySqlDbConfiguration {
		...
		public LocalSessionFactoryBean getSessionFactory() {
			...
			sessionFactory.setPackagesToScan("com.jsp.productService.entity");
		...
		public DataSource getDataSource() {
			...
			dataSource.setUrl("jdbc:mysql://localhost:3306/app_management");
